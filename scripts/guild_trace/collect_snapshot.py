...
def update_indexes(snapshot_id: str, created_at: str) -> None:
    entry = {
        ...
        "path": f"data/guild-trace/snapshots/{snapshot_id}/guilds.json",
    }
    index = {"snapshots": []}
...
def main() -> None:
    ...
    default_member_sources = ["data/guild-trace/raw/trace_who_are_you.json", "data/guild-trace/raw/trace_who_are_you_class.json"]
