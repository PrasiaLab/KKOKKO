...
# =========================================================
# 결사 이동 추적 전용 전체 서버 통합 랭킹 추출기 / GitHub Actions 대응
#
# 생성 파일
...
OUTPUT_DIR = REPO_ROOT / "data" / "guild-trace" / "raw"

OUTPUT_CHARACTER = OUTPUT_DIR / "trace_who_are_you.json"
OUTPUT_GUILD = OUTPUT_DIR / "trace_who_are_you_guild.json"
OUTPUT_CLASS = OUTPUT_DIR / "trace_who_are_you_class.json"
OUTPUT_STATUS = OUTPUT_DIR / "trace_ranking_update_status.json"

# 신규 추가 파일: 기존 4개 JSON과 독립적으로 생성됩니다.
OUTPUT_GUILD_SCORE = OUTPUT_DIR / "trace_who_are_you_guild_score.json"
